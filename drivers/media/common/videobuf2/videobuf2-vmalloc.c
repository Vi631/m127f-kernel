...
const struct vb2_mem_ops vb2_vmalloc_memops = {
    .alloc          = (void *(*)(struct device *, unsigned long, unsigned long,
                                enum dma_data_direction, gfp_t, int)) vb2_vmalloc_alloc,
    .put            = vb2_vmalloc_put,
    .get_userptr    = (void *(*)(struct device *, unsigned long, unsigned long,
                                enum dma_data_direction, int)) vb2_vmalloc_get_userptr,
